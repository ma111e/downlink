...
<p align="center">
  <a href=".github/assets/digest-index.png"><img alt="Digest archive index" src=".github/assets/digest-index.png" width="80%"></a>
  <br><em>Digests index</em>
</p>
<p align="center">
  <a href=".github/assets/digest-row-expanded.png"><img alt="Digest page with an article expanded" src=".github/assets/digest-row-expanded.png" width="80%"></a>
...
**5. Apply the feeds.** `dlk feeds apply -f feeds.yml` reconciles the database to match the file. Feeds in the file are created or updated, and feeds no longer listed are disabled
