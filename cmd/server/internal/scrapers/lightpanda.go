...
const (
	lightpandaCDPHost    = "127.0.0.1"
	lightpandaCDPPort    = "9222"
	lightpandaDockerName = "lightpanda"
)

var lightpandaDockerCmd = fmt.Sprintf("docker run -d --name %s -p %s:%s:%s lightpanda/browser", lightpandaDockerName, lightpandaCDPHost, lightpandaCDPPort, lightpandaCDPPort)
