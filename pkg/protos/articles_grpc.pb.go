...
func (UnimplementedCategoriesServiceServer) GetOrCreateCategory(context.Context, *GetOrCreateCategoryRequest) (*GetOrCreateCategoryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetOrCreateCategory not implemented")
}
...
func (UnimplementedArticleServiceServer) GetArticleCounts(context.Context, *ArticleFilter) (*ArticleCountsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetArticleCounts not implemented")
}
...
func (UnimplementedArticleServiceServer) MarkFeedArticlesRead(context.Context, *MarkFeedReadRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method MarkFeedArticlesRead not implemented")
}
